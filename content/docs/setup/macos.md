...
> [!IMPORTANT]
> Check your Node version first. Node 26 makes every CLI command exit with an
> unhandled error. Node 24 is the newest that works —
...
You are on Node 26. Switch to Node 24 —
