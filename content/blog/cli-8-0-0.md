...
description: 'Maintenance release that drops support for Node.js 18 and older'
date: '2025-08-01'
author: 'Chris Barber'
category: 'Releases'
cover: '/blog/cli/cli-8.0.0.webp'
source: 'https://tidev.io/blog/cli_8_0_0'
social: |-
  Titanium CLI 8.0.0 is out!

  Maintenance release that drops support for Node.js 18 and older

  Blog: https://titaniumsdk.com/blog/cli-8-0-0
  Install: npm i -g titanium@8.0.0

  #titaniumsdk #mobiledev #javascript
---

![Titanium CLI v8.0.0](/blog/cli/cli-8.0.0.webp)
