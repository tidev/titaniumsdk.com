...
description: 'Several bug fixes related to previous releases'
date: '2024-05-30'
author: 'Hans Knöchel'
category: 'Releases'
cover: '/blog/titanium-general.png'
source: 'https://tidev.io/blog/sdk_12_3_1_rc'
social: |-
  Titanium SDK 12.3.1.RC is out!

  Bug fixes, plus support and documentation for the Apple privacy manifests required from May 1, 2024.

  Blog: https://titaniumsdk.com/blog/sdk-12-3-1-rc
  Install: ti sdk i 12.3.1.RC

  #titaniumsdk #mobiledev #javascript
---

![Titanium SDK 12.3.1.RC](/blog/titanium-general.png)
